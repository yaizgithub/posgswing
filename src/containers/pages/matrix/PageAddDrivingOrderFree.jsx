...
import { usePackageDrivingData, usePackageDrivingFreeData, usePackageDrivingNotFreeData } from "../../../hooks/usePackageDrivingData";
...
const PageAddDrivingOrderFree = (props) => {
    ...
    const onChangePackage = (v) => {
        ...
        ///cek pb1
        if (dataPackageDrivingFree?.data[0].tax_status === "1") {
                    ...
                    >
                        ...
                        >
                            {/* <Segmented                            
                                ...
                                options={dataPackageDrivingFree?.data.map((e) => ({
                                    label: (
                                        <div
                                            style={{
                                                padding: 10,
                            ...
                            <Radio.Group buttonStyle="solid" onChange={onChangePackage}>
                                <div className="flex flex-wrap justify-start items-center gap-2">
                                    {dataPackageDrivingFree?.data.map((e, key) => {
                                        return (
                                            <div key={key}>
                                                <Radio.Button
                                                    value={e.id}
...
export default PageAddDrivingOrderFree;
