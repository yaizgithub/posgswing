...
import PageAddQtyReservasi from "./PageAddQtyReservasi";


const PageAddRestoOrderReservasi = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: "2",
            render: (_, record) => {
                return <PageAddQtyReservasi itemTerpilih={record} tanggal={props.tanggal}/>;
            },
        },
    ];
...
export default PageAddRestoOrderReservasi;
