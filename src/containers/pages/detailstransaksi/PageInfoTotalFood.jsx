...
const PageInfoTotalFood = () => {
    ...
    const {
        ...
        isError,
        error,
    } = useGetSumTransaksiRestoData([matrixSelected.registrasi_id,"F", true]);
            ...
            .then(async (res) => {
                if (res.data.success) {
                    if (res.data.data.role === "1") {
                        ...
                        await mutateUpdatePerhitunganTransaksiRestoByRegisId([matrixSelected.registrasi_id, "F", dataA]);
...
export default PageInfoTotalFood;
