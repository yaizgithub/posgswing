...
import { useDeleteUserMenuAplikasiData, useOneUserMenuAplikasi } from '../../hooks/useUserMenuAplikasiData';

const TableOneUserMenuAplikasi = () => {
    ...
    ///HOOKs
    const {mutateAsync: mutateDeleteUserMenuAplikasiData} = useDeleteUserMenuAplikasiData();
    const {data, isLoading, isError, error} = useOneUserMenuAplikasi(dataSelected.id,true);
    if (isLoading) {
        return (
            <div>
                <Skeleton active />
                ...
                <>
                    <Space>
                        <Popconfirm
                            ...
                            description={`Are you sure to delete ${record.label} ?`}
                            onConfirm={() => mutateDeleteUserMenuAplikasiData(record.id)}
                            // onCancel={cancel}
                            okText="Yes"
                            cancelText="No"
                        >
...
export default TableOneUserMenuAplikasi