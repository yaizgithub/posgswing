...
const AddRegisFormDrivingOrder = (props) => {
    ...
    const onFinish = async (v) => {
        ...
        await axios
            .get(
                baseUrl +
                `/transaksi-driving/generate?registrasi_id=${numberIdentifikasi}`
            )
            .then(async (res) => {
                ...
                await dataPostRegistrasiDriving(data);
...
export default AddRegisFormDrivingOrder;
